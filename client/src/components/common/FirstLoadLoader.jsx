...
export default function FirstLoadLoader() {
  ...
  return (
    <div className={`first-load-loader${leaving ? " is-leaving" : ""}`} role="status" aria-live="polite" aria-label="Loading Award Arts">
      <div className="first-load-loader__panel">
        ...
        <p className="first-load-loader__eyebrow">Award Arts</p>
