...
export const products = rawProducts.map(([name, category, price, tag, description, badge, image, material, size, delivery, useCase]) => ({
  id: slugify(name), name, category, price, tag, description, badge,
  image: images[image], material, size, delivery, useCase,
